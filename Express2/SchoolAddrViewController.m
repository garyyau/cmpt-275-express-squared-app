...
#import "SchoolAddrViewController.h"

@interface SchoolAddrViewController ()

@end

@implementation SchoolAddrViewController
...
- (void)viewDidLoad {
    ...
    NSString *SchoolName = [defaults objectForKey:@"SchoolName"];
    ...
    SchoolAddressTextField.text = SchoolAddress;
    SchoolCityTextField.text = SchoolCity;
    SchoolProvinceTextField.text = SchoolProvince;
    SchoolZipTextField.text = SchoolZip;
    SchoolCountryTextField.text = SchoolCountry;
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if(buttonIndex==0) {
        ...
        NSLog(@"Data saved");
        [self performSegueWithIdentifier:@"SubmitSchoolAddress" sender:self];
    }
}
@end
