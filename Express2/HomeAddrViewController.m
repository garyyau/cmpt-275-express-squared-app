...
#import "HomeAddrViewController.h"

@interface HomeAddrViewController ()

@end

@implementation HomeAddrViewController
...
- (void)viewDidLoad {
    ...
    HomeCityTextField.text = HomeCity;
    HomeProvinceTextField.text = HomeProvince;
    HomeZipTextField.text = HomeZip;
    HomeCountryTextField.text = HomeCountry;
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if(buttonIndex==0) {
        ...
        NSLog(@"Data saved");
        [self performSegueWithIdentifier:@"SubmitHomeAddress" sender:self];
    }
}
